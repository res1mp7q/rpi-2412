...
sleep 3
#Enviro Variables#
#echo "Please enter your target Raspberry PI's IP address: "
#read -r RPI_IP_INPUT
#export RPI_IP=\$RPI_IP_INPUT
...
echo "Please enter your RPI Hostname: "
...
#echo "$(tput setaf 45)  **************************************************************************************"
#echo "$(tput setaf 45)  *                               Starting Connection                                  *"
#echo "$(tput setaf 45)  **************************************************************************************"
#echo "$(tput setaf 7)"
#echo "Connecting...."
#sleep 3
#spawn ssh pi@$RPI_IP_INPUT
#expect "password:"
#sleep 1
#send "$RPI_DEFAULT_PASSWORD\r"
...
#Configure SSHD
echo $"Updating SSHD to allow key access only via Port TCP/2122"
...
sed -i "s|#Port 22|Port $RPI_SSHPORT|g" /etc/ssh/sshd_config
